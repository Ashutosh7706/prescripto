...
const getProfile = async (req, res) => {
 try {
const userIde = req.userId
const   userData  = await userModel.findById(userIde).select('-password')
...
if(appointmentData.userId !== userId){
    return res.json({success:false,message:'Unothorized action'})
}
...
{
    return res.json({success:false,mesasge:"Appointment Cancelled or not found."})
